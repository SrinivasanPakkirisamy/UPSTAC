...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester()  {
        ...
        // Create an object of User class and store the current logged in user first - <SRINIVASAN PAKKIRISAMY : User (tester) object is created. It stores the current logged in user>
        ...
        //throw new ResponseStatusException(HttpStatus.NOT_IMPLEMENTED,"Not implemented"); // replace this line with your code - <SRINIVASAN PAKKIRISAMY : This is commented / removed as the method is implemented as expected>
